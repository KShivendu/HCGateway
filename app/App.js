...
const DEFAULT_GATEWAY_URL = 'https://api.hcgateway.shuchir.dev';
const LOCAL_GATEWAY_URL = 'http://192.168.29.248:6644';
const GET_LAST_N_DAYS = 1;
const GET_LAST_N_HOURS = 0.5;
const SYNC_EVERY_N_HOURS = 0.25; // Sync every 15 minutes
            ...
            timeRangeFilter: {
              ...
              startTime: String(
                new Date(
                  ...
                  new Date() * 1 - GET_LAST_N_HOURS * 60 * 60 * 1000,
                ).toISOString(),
              ),
          ...
          {!userLoggedIn ? (
            ...
            <Layout style={styles.container}>
              ...
              <Text>
                ...
                it with anyone. It will push data for last {GET_LAST_N_DAYS} days.
              </Text>
            </Layout>
          )}
        </Layout>
